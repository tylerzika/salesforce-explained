...
export default class CreateTestProvider extends LightningElement {
  @api cardTitle = 'Create Test Provider';
  @api autoRun = false;
  ...
  reduceError(error) {
    ...
    return 'Unexpected error while creating the provider.';
  }
}
